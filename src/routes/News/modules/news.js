...
// Constants
// ------------------------------------
export const REQUEST_POSTS = 'REQUEST_POSTS_NEWS'
export const RECEIVE_POSTS = 'RECEIVE_POSTS_NEWS'
