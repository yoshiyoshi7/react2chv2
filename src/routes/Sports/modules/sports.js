...
// Constants
// ------------------------------------
export const REQUEST_POSTS = 'REQUEST_POSTS_SPORTS'
export const RECEIVE_POSTS = 'RECEIVE_POSTS_SPORTS'
...
export const receivePosts = (json) => ({
  type: RECEIVE_POSTS,
  posts_sports: json.map(item => item)
})
